...
const Addnew = (props) => {
    ...
    return (
        <div>
            <button type="button" className="btn btn-outline-primary rounded-pill w-auto d-flex justify-content-end ms-5" data-bs-toggle="modal" data-bs-target={"#exampleModal"+index}>
                ADD NEW
            </button>
